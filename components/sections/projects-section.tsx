...
const projects = [
  {
    ...
    desc: "A polished case study placeholder ready to be replaced with your real work.",
  ...
  },
  {
    ...
    desc: "Add a product, experiment, or client build here when you are ready.",
  ...
  },
  {
    ...
    desc: "Use this space to showcase a design system, SaaS idea, or personal build.",
